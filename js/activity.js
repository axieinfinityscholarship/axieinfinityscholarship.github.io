...
let flagList = ['PL', 'UK', "FR", "DE","UA", "BG", "AR", "RU", "BE", "BG", "ES", "PH", "BR"]
...
addNewUser = () => {
    ...
    div.innerHTML = `<div class='icon-flag icon-flag-${flag}'></div><h5 class='activity-text'><span class='strong'>${user} </span>was selected for Axie Infinity Scholarship. </h5>`
